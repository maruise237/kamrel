...
const testimonials = [
  {
    name: "Amadou Diallo",
    username: "@amadou_tech",
    body: "Kamrel a transformé notre agence. On gère 15 projets clients sans stress. La règle des 3 clics, c'est du génie !",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Fatou Ndiaye",
    username: "@fatou.codes",
    body: "Enfin un outil pensé pour nous ! Fonctionne parfaitement même avec notre connexion instable. Support en français au top.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Jean-Pierre Kouassi",
    username: "@jpkouassi",
    body: "Notre startup a lancé 3 produits en 6 mois grâce à Kamrel. L'équipe reste synchronisée même en télétravail.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Aïcha Traoré",
    username: "@aicha_pm",
    body: "Le Gantt automatique nous a sauvés sur un projet complexe. Plus besoin de passer des heures à tout configurer.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Moussa Camara",
    username: "@moussacam",
    body: "Kamrel comprend nos besoins. Paiement Mobile Money, serveurs rapides, et prix adaptés. Parfait pour notre PME.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Marie Kaboré",
    username: "@mariekabore",
    body: "Notre ONG gère 8 projets humanitaires avec Kamrel. Simple, efficace, et le support répond en français rapidement.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Ibrahim Sow",
    username: "@ibrahim_dev",
    body: "En tant que développeur solo, Kamrel me permet de gérer plusieurs clients sans m'y perdre. L'IA suggère bien.",
    img: "https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Nadia Benali",
    username: "@nadiabenali",
    body: "Formation de 5 minutes et toute l'équipe était opérationnelle. Nos clients adorent les rapports automatiques.",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Kofi Mensah",
    username: "@kofi_builds",
    body: "Kamrel a réduit nos réunions de 50%. Tout est clair dans l'app. Le mode hors ligne est un vrai plus pour nous.",
        ...
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="relative text-white">Témoignages</span>
            </button>
          </div>
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            Des PME, startups et ONG africaines qui ont transformé leur gestion de projet avec Kamrel.
          </p>
        </div>
