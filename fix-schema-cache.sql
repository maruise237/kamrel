-- Script pour résoudre les problèmes de cache de schéma et RLS

-- 1. Rafraîchir le cache de schéma PostgREST
NOTIFY pgrst, 'reload schema';

-- 2. Vérifier et corriger les politiques RLS pour les équipes
DROP POLICY IF EXISTS "Users can view teams they belong to" ON teams;
DROP POLICY IF EXISTS "Team owners can update their teams" ON teams;
DROP POLICY IF EXISTS "Users can create teams" ON teams;

-- Politiques permissives pour les équipes
...
-- 3. Corriger les politiques pour team_members
...
-- 4. Corriger les politiques pour projects
...
-- 7. Rafraîchir à nouveau le cache
NOTIFY pgrst, 'reload schema';